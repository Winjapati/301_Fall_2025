...
<!-- NOTE TO SELF:  HAVE USERS INSTALL RSTUDIO AND GIT BEFOREHAND!!!!! Make this an in-class workshop day for those who can't get things to work. -->

<!-- ADD THIS TO SLIDES NEXT TIME, make sure they select the "SSH" link, not  -->

<!-- If GitHub is asking for a "Personal Access Token", even if you have set up the SSH protocol properly, here's what you need to do.  (This is currently to my knowledge only affecting Mac users) -->

<!-- 1\) Delete the project in your RStudio.  We're going to set up the repo in RStudio again. -->

<!-- 2\) Go to your GitHub repo page. -->

<!-- 3\) Click the green "\<\> Code" button in the home page of the repo. -->

<!-- 4\) Select "Local" -->

<!-- 5\) Select "SSH" -->

<!-- 6\) Copy the SSH address.  It should look something like "git\@github.com:Winjapati/301_Fall_2025.git" -->

<!-- 7\) Use that link to set up your repo on RStudio as you did before.  That link is being used for the Git URL in RStudio. -->

<!-- 8\) Test to make sure that you can push to GitHub by editing (and saving) your README.md file. -->

<!-- Let me know if you CANNOT get this to work.  It's crucial that we're all on the same page as we venture into HTML. -->
...
-   Go to your GitHub repo page (LIN_301)
