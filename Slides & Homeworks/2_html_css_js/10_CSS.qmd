...
## Step 3: Create a `docs` folder in `yourusername.github.io`

- In your local repo, make a folder named **docs**.
- In RStudio: 
...
- Copy your finished `.html` and `.css` files into `docs`  
- Note: your homepage **must be named `index.html`*
  
## Step 3: Save, Stage, Commit, Push!

## Step 4: GitHub Settings

- Go to your LIN_301 repo
- Visit Settings → Pages  
- Under “Branch,” choose **main** and folder **/docs**
- Save

## Step 5: Loading Your Page

- **Wait a minute**  
- GitHub builds your site automatically.  
- You’ll see a green check + a URL like:  `https://yourusername.github.io/your-repo-name`

---

## Tips & Gotchas

- Your homepage must be called **index.html** (GitHub looks for this by default).  
- If you want multiple pages, just add links between your `.html` files.  
- Updates?  
  - Edit locally → commit → push → GitHub Pages rebuilds automatically.  
- If something’s not working, double-check:  
  - Branch = `main`  
  - Directory = `/root` (or `/docs`)  
  - File names have **no spaces**.
...
- Copy your site link into the shared class doc!
