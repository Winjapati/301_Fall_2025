...
-   lemma\_ – base form (great for type–token counts, lexeme stats).
-   pos\_ – Universal POS tag (quick, language-agnostic part of speech).
-   tag\_ – Fine-grained POS (useful for English-specific distinctions).
...
- Copy the below `jfk` list, and then analyze its attributes.
