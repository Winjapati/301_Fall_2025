...
<!-- Also: make sure to a) show them how to download/install Python *before* class begins & b) that they must identify their Python compiler in RStudio (Tools > ... > Python) -->
