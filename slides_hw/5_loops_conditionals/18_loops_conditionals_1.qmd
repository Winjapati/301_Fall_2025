...
- If you divide an even number by 2, it will have no remainder
- If you divide an odd number by 2, it will have a remainder of 1. 
...
- Let's write a short block of code that will print <x> is even if the number assigned to x is even like so. 
...
1. Logical statement x % 2 == 0. This statement is checking to see if the outcome of x % 2 is exactly equal to 0. If we run it as its own line of code, we'll get True.
