...
-   **Commands as instructions**
    ...
    -   You have seen learned about proper syntax, flags/options, and order of operations.
...
![Tools \> Global Options \> Terminal \> "New terminals open with:" = "GitBash"](12_bash_settings.png){alt="You should have the setting \"New terminals open with:" width="50%"}
:::
...
- Look in the right corner panel of RStudio, what do you see?
