...
print("In Mansfield Park, there are: \n", adv_count_mans,"adverbs in '-ly'\n", wise_count_mans, "forms ending in '-wise'\n", pst_count_mans, "past tense forms in '-ed'\n", "and", pre_count_mans, "forms prefixed with 'pre-'")
...
print("In Alice, there are: \n", adv_count_alice,"adverbs in '-ly'\n", wise_count_alice, "forms ending in '-wise'\n", pst_count_alice, "past tense forms in '-ed'\n", "and", pre_count_alice, "forms prefixed with 'pre-'")
```
...
print("The most common 20 words in Alice are:", sort_alice[:20])
```
